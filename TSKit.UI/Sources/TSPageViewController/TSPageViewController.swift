...
public class TSPageViewController: UIViewController, TSPageControlDelegate, Loggable {
    ...
    @IBOutlet public var pageControl: TSPageControl? {
        didSet {
    ...
    public var pageDelegate: TSPageViewControllerDelegate?

    /// Data source providing `UIViewController` pages to `TSPageViewController`
    public var pageDataSource: TSPageViewControllerDataSource?
